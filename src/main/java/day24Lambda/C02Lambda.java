...
//Example 3: Create a method checks if the length of all elements is greater than a given value
...
//Example 5: Create a method if no element starts with the given value
