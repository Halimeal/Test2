...
public class C08SwitchStatement {
    public static void main(String[] args) {
        ...
        System.out.println( "Enter day number to see the name");
        ...
        switch (dayNum){
            ...
            default:
                System.out.println("Invalid day number");
                break; // default is the last part in swtich statement, that is why using "break" after default is optional
